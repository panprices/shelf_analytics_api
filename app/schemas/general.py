...
class TrackedRetailerPool(BaseModel):
    ...
    retailers: List[NamedRetailer] = Field(
        ...
        example=[
            {
                "name": "Homeroom",
                "id": "14011acc-77c6-4aea-998e-12af3fd9a5d1"
            },
            {
                "name": "Trademax",
...
class NamedProductCategory(BaseModel):
    name: str = Field(description="The name of the category. This is the name of the leaf category")
...
class ProductCategorisation(BaseModel):
    ...
    categories: List[NamedProductCategory] = Field(
        ...
        example=[{
            "name": "Utemobler",
            "id": "ab7b09e7-18b4-49c8-8cc6-57132eb8b820"
        }]
    )
